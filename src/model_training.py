    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                logger.info("Logging the training and testing dataset to mlfow")
                ...
                logger.info("Logging the model to mlfow")
                mlflow.log_artifact(self.model_output_path, artifact_path="models")

                mlflow.log_params(best_lgbm_model.get_params())
                mlflow.log_metrics(metrics) ##all metrics are saved in metrics variable
